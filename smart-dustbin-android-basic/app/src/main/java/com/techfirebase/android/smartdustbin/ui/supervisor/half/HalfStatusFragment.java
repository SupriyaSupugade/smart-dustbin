...
public class HalfStatusFragment extends Fragment {
  ...
  private List<HalfStatusModel> halfFilledList;
  private ApiInterface apiInterface;
  private ProgressBar spinner;

  public HalfStatusFragment() {}
  ...
  private void getDustbinList() {
    /*halfFilledList = new ArrayList<>();
    apiInterface = ApiClient.getClient().create(ApiInterface.class);

    apiInterface
        .getDustbinList("half-filled")
        .enqueue(
            new Callback<List<DustbinResponse>>() {
              ...
              public void onResponse(
                ...
                if (halfFilledList.isEmpty()) {
                  ...
                  // specify an adapter
                  mAdapter = new HalfStatusAdapter(halfFilledList);
                  // set the adapter
