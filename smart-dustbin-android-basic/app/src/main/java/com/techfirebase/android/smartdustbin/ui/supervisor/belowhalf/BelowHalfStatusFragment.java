...
public class BelowHalfStatusFragment extends Fragment {
  ...
  private List<BelowHalfStatusModel> belowHalfFilledlList;
  private ProgressBar spinner;

  public BelowHalfStatusFragment() {}
  ...
  private void getDustbinList() {
    /*belowHalfFilledlList = new ArrayList<>();
    apiInterface = ApiClient.getClient().create(ApiInterface.class);

    apiInterface
        .getDustbinList("below-half-filled")
        .enqueue(
              ...
              public void onResponse(
                ...
                if (dustbinList != null) {
                  for (DustbinResponse dustbinResponse : dustbinList) {
                    ...
                    belowHalfFilledlList.add(
                        new BelowHalfStatusModel(
                            area.getDustbinId(),
                            area.getAreaName(),
                ...
                if (belowHalfFilledlList.isEmpty()) {
                  ...
                  // specify an adapter
                  mAdapter = new BelowHalfStatusAdapter(belowHalfFilledlList);
                  // set the adapter
